...
class PolymarketClient:
    ...
    def get_market_by_slug(self, slug):
        """
        DEPRECATED: Get market data using event slug
        
        ⚠️ WARNING: This method is DEPRECATED for runtime use.
        Runtime code should use get_orderbook(token_id) with numeric token IDs.
        
        This method is only for initial token resolution in resolve_markets_v2.py.
        
        For orderbook depth, use: get_token_ids_from_slug() + get_orderbook(token_id)
        """
    ...
    def get_markets_parallel(self, slugs, max_workers=15):
        """
        DEPRECATED: Get market data for multiple slugs in parallel
        
        ⚠️ WARNING: This method is DEPRECATED for runtime use.
        Runtime code should use batch token ID fetching with get_orderbook().
        """
